...
| `quality` | string | ❌ | "auto" | Output quality: `"low"`, `"medium"`, `"high"`, `"auto"` |
...
| `"medium"` | Balanced quality/speed | Moderate |
| `"high"` | Best quality, slower generation | Higher |
| `"auto"` | Model decides based on prompt | Variable |

> **Note:** `"standard"` and `"hd"` are NOT valid for gpt-image-1.5. These were DALL-E parameters.
...
|------|---------|------------------|
| 1024×1024 | low | ~$0.02 |
| 1024×1024 | medium | ~$0.03 |
| 1024×1024 | high | ~$0.04-0.08 |
| 1536×1024 | low | ~$0.03 |
| 1536×1024 | medium | ~$0.05 |
| 1536×1024 | high | ~$0.06-0.12 |
| 1024×1536 | low | ~$0.03 |
| 1024×1536 | medium | ~$0.05 |
| 1024×1536 | high | ~$0.06-0.12 |
